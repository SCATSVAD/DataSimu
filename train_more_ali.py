...
def get_more_type_array(count, isLinear=False, diameter=0.102, distance=0.04):
    ...
    Supported type: 'Ambisonics', 'Binaural', 'Mono', 'CustomArrayIR'
    For CustomArrayIR
    ...
    '''
    diameter = round(random.uniform(0.082, 0.122), 3) 
    distance = round(random.uniform(0.020, 0.060), 3) 
...
if __name__ == "__main__":
    ...
    for mode in ['train']:
        ...
        with open(f'{data_dir}/origin_wav_0.scp', 'r')as f:
